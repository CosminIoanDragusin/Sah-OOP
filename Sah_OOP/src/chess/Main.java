...
public class Main extends JFrame implements MouseListener
{
	...
	private JPanel bcombopanel=new JPanel();
        ...
        private final JPanel displayTime;
	private final JPanel showPlayer;
	private final JPanel time;
	...
	private Main()
    {
		...
		controlPanel.setBorder(BorderFactory.createTitledBorder(null, "Statistici", TitledBorder.TOP,TitledBorder.CENTER, new Font("Lucida Calligraphy",Font.PLAIN,20), Color.ORANGE));
		
		//Defining the Player Box in Control Panel
		WhitePlayer=new JPanel();
		WhitePlayer.setBorder(BorderFactory.createTitledBorder(null, "Jucatorul ALB", TitledBorder.TOP,TitledBorder.CENTER, new Font("times new roman",Font.BOLD,18), Color.RED));
		WhitePlayer.setLayout(new BorderLayout());
		
		BlackPlayer=new JPanel();
		BlackPlayer.setBorder(BorderFactory.createTitledBorder(null, "Jucatorul NEGRU", TitledBorder.TOP,TitledBorder.CENTER, new Font("times new roman",Font.BOLD,18), Color.BLUE));
		...
		wselect=new Button("Selecteaza");
		bselect=new Button("Selecteaza");
		wselect.addActionListener(new SelectHandler(0));
		bselect.addActionListener(new SelectHandler(1));
		WNewPlayer=new Button("Jucator Nou");
		BNewPlayer=new Button("Jucator Nou");
		...
		whitestats.add(new JLabel("Nume   :"));
		whitestats.add(new JLabel("Numar de jocuri :"));
		whitestats.add(new JLabel("Castigate    :"));
		blackstats.add(new JLabel("Nume   :"));
		blackstats.add(new JLabel("Numar de jocuri :"));
		blackstats.add(new JLabel("Castigate    :"));
		...
		JLabel setTime=new JLabel("Seteaza timerul (in minute):"); 
		start=new Button("Incepe");
		...
		temp=new JPanel(){
		    ...
		    public void paintComponent(Graphics g) {
				  try {
			          image = ImageIO.read(this.getClass().getResource("cool_chess (1).jpg"));
			       } catch (IOException ex) {
			            System.out.println("Nu s-a gasit poza");
			       }
